-- Work Management v1.16.0 RBAC implementation reconciliation.
-- Run this single migration on existing v1.12-v1.14.1 databases.
-- It is idempotent and repairs the legacy constraint, role vocabulary, bootstrap
-- administrator assignment, protected RPCs, and module-role synchronization.
