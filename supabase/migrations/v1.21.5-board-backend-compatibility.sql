-- Work Management v1.21.5 — resilient flexible board creation backend compatibility
begin;
...
-- Force PostgREST to discover the new/updated RPC signatures immediately after migration.
